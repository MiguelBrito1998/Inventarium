...
sql5="CREATE TABLE Venta(ID int auto_increment,ID_cliente int, Compra int, Monto_total int, IVA int,  Fecha_creacion timestamp default current_timestamp, Fecha_actualizacion timestamp default current_timestamp, primary key(ID)     )"
