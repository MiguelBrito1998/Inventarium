from Conexion import conectar, cursor
...
sql5="CREATE TABLE Venta(ID int auto_increment, ID_cliente int  , Compra json, IVA DECIMAL(10, 2) , Monto_Total float  , Fecha_creacion timestamp default current_timestamp, Fecha_actualizacion timestamp default current_timestamp, primary key(ID))"
